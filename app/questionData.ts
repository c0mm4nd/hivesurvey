...
export const initialQuestions: Question[] = [
  ...
  {
    id: 1,
    stem: "Part II. Background Information \n Question 1: Are you a user in Steem chain registered before February 14?",
    type: QuestionType.Single,
    textDesc: "Yes or No",
  ...
  {
    id: 11,
    stem: "Part III.  Demographic Information  \n Question 1: Which age group do you belong to by February 14, 2020?",
    type: QuestionType.Single,
    textDesc: "Pick one",
    options: {
  ...
  {
    id: 18,
    stem: "Part IV. Event-related Information \n Question 1: Rate the appropriateness of Tron’s takeover event on February 14, 2020: (1 = “Fully appropriate”, 4 = “No opinion”, 7 = “Fully inappropriate”)",
    type: QuestionType.Slider,
    range: [1, 7], next: 19
  },
  {
